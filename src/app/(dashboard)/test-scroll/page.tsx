...
const generateSectionData = (index: number) => {
  // Use index as seed for consistent values per section
  const seed = index + 1;
  return {
    activeRovers: ((seed * 3) % 15) + 5,
    resources: ((seed * 137) % 500) + 500,
    efficiency: ((seed * 7) % 20) + 80,
    maintenance: ((seed * 11) % 30) + 1,
    rareEarth: ((seed * 13) % 40) + 10,
    contractDays: ((seed * 17) % 60) + 30,
  };
};
  ...
  return (
    <PageContainer>
      ...
      {Array.from({ length: 10 }, (_, index) => {
        const data = generateSectionData(index);
        return (
          <Paper
            key={index}
            elevation={1}
          ...
          >
            ...
            <Typography variant="body1" paragraph>
              ...
              Universal Opportunities across various planetary systems. Each
              rover deployment represents a significant investment in both human
              and technological resources, requiring careful monitoring and
              strategic planning.
            </Typography>
                  ...
                  <List dense>
                    ...
                    <ListItem>
                      <ListItemText
                        ...
                        secondary={`${data.resources} tons this cycle`}
                      />
                    </ListItem>
                    <ListItem>
                      <ListItemText
                        primary="System Efficiency"
                        secondary={`${data.efficiency}% operational capacity`}
                      />
                    </ListItem>
                    <ListItem>
                      <ListItemText
                        primary="Next Maintenance Window"
                        secondary={`${data.maintenance} days from now`}
                      />
                    </ListItem>
                  </List>
                </CardContent>
              ...
              <Card variant="outlined" sx={{ flex: 1 }}>
                <CardContent>
                  ...
                  <Typography variant="body2" paragraph>
                    The mining operations in this sector have yielded
                    exceptional results, with rare earth elements comprising{' '}
                    {data.rareEarth}% of total extracted materials. Quality
                    assessments indicate optimal purity levels across all
                    mineral categories.
                  </Typography>
                  <Typography variant="body2" paragraph>
                  ...
                  <Typography variant="body2">
                    ...
                    {data.contractDays} days, with potential for early delivery
            ...
            <Typography variant="body2" paragraph>
              ...
              and proactive maintenance scheduling. Our operators work around
              the clock to ensure maximum uptime and efficiency across all
              deployed systems.
            </Typography>
            <Typography variant="body2">
              Communication delays with Earth-based control centers have been
              mitigated through improved autonomous decision-making algorithms
